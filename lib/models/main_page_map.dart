...
Map<String, dynamic> constData = {
  'writer': 'ملیکا عزیزی - یک روز پیش',
  'views': '250',
  'posteTitle': 'دسترسی بیشتر به سیستم ها'
};

//fake tage
List<TagModel> tagList = [
  TagModel(title: 'جاوا', id: '1'),
  TagModel(title: 'فلاتر', id: '2'),
  TagModel(title: 'برنامه نویسی وب', id: '3'),
  TagModel(title: 'اینترنت اشیا', id: '4'),
  TagModel(title: 'برنامه نویسی پایتون', id: '5')
];

List<TagModel> mySelectedTag = [];
